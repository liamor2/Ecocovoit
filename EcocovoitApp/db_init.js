...
async function createExampleData() {
  ...
  const users = await User.insertMany([
    { username: 'John Shepard', email: 'john.shepard@gmail.com', address: '123 Main St, City A', password: await bcrypt.hash('password1', salt), points: 0, role: 1, redeemedRewards: []},
    { username: 'Jane Shepard', email: 'jane.shepard@gmail.com', address: '456 Elm St, City B', password: await bcrypt.hash('password2', salt), points: 0, role: 0, redeemedRewards: []},
    { username: 'Alex Smith', email: 'alex.smith@gmail.com', address: '789 Oak St, City C', password: await bcrypt.hash('password3', salt), points: 0, role: 0, redeemedRewards: []}
  ]);
